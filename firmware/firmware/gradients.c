...
new FormPalette()
{
    ...
    Entries =
    {
        new PaletteEntry() { Step = 0, 194,  1,  1,
        new PaletteEntry() { Step = 94,   1, 29, 18,
        new PaletteEntry() { Step = 132,  57,131, 28,
        new PaletteEntry() { Step = 255, 113,  1,  1
    }
},
...
new FormPalette()
{
    ...
    Entries =
    {
        new PaletteEntry() { Step = 0,   2,  1,  1,
        new PaletteEntry() { Step = 53,  18,  1,  0,
        new PaletteEntry() { Step = 104,  69, 29,  1,
        new PaletteEntry() { Step = 153, 167,135, 10,
        new PaletteEntry() { Step = 255,  46, 56,  4
    }
},
...
new FormPalette()
{
    ...
    Entries =
    {
        new PaletteEntry() { Step = 0,   4,  1,  1,
        new PaletteEntry() { Step = 51,  16,  0,  1,
        new PaletteEntry() { Step = 76,  97,104,  3,
        new PaletteEntry() { Step = 101, 255,131, 19,
        new PaletteEntry() { Step = 127,  67,  9,  4,
        new PaletteEntry() { Step = 153,  16,  0,  1,
        new PaletteEntry() { Step = 229,   4,  1,  1,
        new PaletteEntry() { Step = 255,   4,  1,  1
    }
},
